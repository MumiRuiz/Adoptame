...
class Admin::InstitutionsControllerTest < ActionController::TestCase
  ...
  test "should create admin_institution" do
    assert_difference('Admin::Institution.count') do
      post :create, admin_institution: { address: @admin_institution.address, city: @admin_institution.city, country: @admin_institution.country, description: @admin_institution.description, email: @admin_institution.email, manager: @admin_institution.manager, name: @admin_institution.name, password: @admin_institution.password, state: @admin_institution.state, username: @admin_institution.username, website: @admin_institution.website }
    end
  ...
  test "should update admin_institution" do
    patch :update, id: @admin_institution, admin_institution: { address: @admin_institution.address, city: @admin_institution.city, country: @admin_institution.country, description: @admin_institution.description, email: @admin_institution.email, manager: @admin_institution.manager, name: @admin_institution.name, password: @admin_institution.password, state: @admin_institution.state, username: @admin_institution.username, website: @admin_institution.website }
    assert_redirected_to admin_institution_path(assigns(:admin_institution))
  end
